...
<script>
   $(document).ready(function(e) {
		...
		setTimeout(function(){
			$("div[debug-id='slide-0'] img").trigger("click");
			$("div[debug-id='slide-board'] > div").click(function(){
				$("div[debug-id='slide-board'] > div").removeClass("active");	
...
<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="item active">
      <img src="<?php echo base_url();?>webroot/img/slider_img/img1.png" alt="...">
    </div>
    <div class="item">
      <img src="<?php echo base_url();?>webroot/img/slider_img/img2.png" alt="...">
    </div>
  </div>
